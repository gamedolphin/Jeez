...
Circle.prototype = {
  ...
  copyTo: function (dest) {
    ...
    dest.x = this.x;
    dest.y = this.y;
    dest.position.x = this.x;
    dest.position.y = this.y;
  ...
  distance: function (dest, round) {
    ...
    var distance = this.position.distanceTo(dest);
...
Circle.intersects = function (a, b) {
  return (a.position.distanceTo(b) <= (a.radius + b.radius));
};
